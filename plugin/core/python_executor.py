        ...
        if bn:
            if isinstance(value, bn.Function):
                return {
                    ...
                    "calling_convention": str(value.calling_convention)
                    if value.calling_convention
                    else None,
                }
                ...
                return {
                    ...
                    "symbol_type": str(value.type),
                }
            elif isinstance(value, bn.Type):
                return {"type": "BinaryNinja.Type", "string": str(value), "width": value.width}
